        ...
        <div className="bg-[#F4F3F0] md:p-12">
            ...
            <form onSubmit={handleUser} className="flex flex-col items-center">
                <div className="form-control md:w-1/2 mb-2">
                    ...
                    <input type="text" name="uid" placeholder="ID" className="input input-bordered w-full" />
                    </label>
                </div>
                <div className="form-control md:w-1/2 mb-2">
                    <label className="label">
                ...
                <input type="submit" value="Register Now" className="btn btn-block bg-blue-300 hover:bg-blue-400 hover:border-[#331A15] text-[#331A15]" />
            </form>
        </div>
    );
};
