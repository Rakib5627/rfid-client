...
const Navbar = () => {
    ...
    <li className=""><NavLink to="/user-data">User Data</NavLink></li>
    <li className=""><NavLink to="/registration">Registration</NavLink></li>
    <li className=""><NavLink to="/readTagId">Read Tag Id</NavLink></li>
</>
